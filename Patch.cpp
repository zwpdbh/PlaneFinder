...
Patch::Patch(std::vector<PlyPoint *> points) {
...
double Patch::computeMean(std::vector<double> *d) {
    double total = 0;
...
double Patch::computeCovariance(std::vector<double> *d1, std::vector<double> *d2) {
    if (d1->size() != d2->size()) {
...
void Patch::centerDataAtZero(std::vector<double> *d) {
